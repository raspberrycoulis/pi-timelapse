...
timelapse = 10 #set this to the number of minutes you wish to run your timelapse camera
...
datetimeformat = dateraw.strftime("%d %m %Y at %H:%M")
print("Started: " + datetimeformat)
